...
1. ANOVA to compare forest type between species
2. Correlation to see which variable to measuring the same thing
3. Principal Components Analysis to
4. Discriminant Analysis to 
5. Linear model to
